...
M.change_theme = require "core-ext.change_theme"
...
M.reload_config = require "core-ext.reload_config"
...
M.reload_theme = require "core-ext.reload_theme"

-- toggle between 2 themes
-- argument should be a table with 2 theme names
M.toggle_theme = require "core-ext.toggle_theme"
